  ...
  describe '#call' do
    context 'when question is valid' do
      ...
      it 'saves the question' do
        expect { described_class.call(question_params, user) }.to change(Question, :count).by(1)
      end

      it 'creates author subscription' do
        described_class.call(question_params, user)
    ...
    context 'when question is invalid' do
      ...
      it 'raises ActiveRecord::RecordInvalid' do
        expect { described_class.call(question_params, user) }.to raise_error(ActiveRecord::RecordInvalid)
      end
